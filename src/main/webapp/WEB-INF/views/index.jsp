            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse navbar-left">
                    <ul class="nav navbar-nav">
                        <li><a href="#"><span data-hover="Home">主页</span></a></li>
                        <li><a href="#about"><span data-hover="About">标签</span></a></li>
                    </ul>
                </div>
            </div>
        </nav>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="first-slide" src="static/images/banner3.jpg" alt="First slide">
        </div>
        <div class="item">
            <img class="second-slide" src="static/images/banner2.jpg" alt="Second slide">
        </div>
        <div class="item">
            <img class="third-slide" src="static/images/banner1.jpg" alt="Third slide">
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <img src="static/images/about-img.jpg" alt="about" class="img-responsive slideanim">
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6">
    ...
    <div id="features">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="static/images/service-img.jpg" class="img-responsive slideanim" alt="service">
                </div>
            </div>
        </div><!--/ .container -->
    </div><!--/ #features -->
...
<section class="our-gallery" id="gallery">
    ...
    <p class="text-center slideanim">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
    <div class="container">
        <img src="static/images/gallery-img1.jpg" data-darkbox="static/images/gallery-img1-1.jpg" data-darkbox-description="<b>Lorem Ipsum</b><br>Lorem ipsum dolor sit amet" class="img-responsive slideanim">
        <img src="static/images/gallery-img2.jpg" data-darkbox="static/images/gallery-img2-2.jpg" data-darkbox-description="<b>Lorem Ipsum</b><br>Lorem ipsum dolor sit amet" class="img-responsive slideanim">
        <img src="static/images/gallery-img3.jpg" data-darkbox="static/images/gallery-img3-3.jpg" data-darkbox-description="<b>Lorem Ipsum</b><br>Lorem ipsum dolor sit amet" class="img-responsive slideanim">
        <img src="static/images/gallery-img4.jpg" data-darkbox="static/images/gallery-img4-4.jpg" data-darkbox-description="<b>Lorem Ipsum</b><br>Lorem ipsum dolor sit amet" class="img-responsive slideanim">
        <img src="static/images/gallery-img5.jpg" data-darkbox="static/images/gallery-img5-5.jpg" data-darkbox-description="<b>Lorem Ipsum</b><br>Lorem ipsum dolor sit amet" class="img-responsive slideanim">
        <img src="static/images/gallery-img6.jpg" data-darkbox="static/images/gallery-img6-6.jpg" data-darkbox-description="<b>Lorem Ipsum</b><br>Lorem ipsum dolor sit amet" class="img-responsive slideanim">
        <img src="static/images/gallery-img7.jpg" data-darkbox="static/images/gallery-img7-7.jpg" data-darkbox-description="<b>Lorem Ipsum</b><br>Lorem ipsum dolor sit amet" class="img-responsive slideanim">
        <img src="static/images/gallery-img8.jpg" data-darkbox="static/images/gallery-img8-8.jpg" data-darkbox-description="<b>Lorem Ipsum</b><br>Lorem ipsum dolor sit amet" class="img-responsive slideanim">
    </div>
</section>
<!-- /Gallery Section -->
<!-- Testimonials -->
<section class="our-testimonials slideanim" id="testimonials">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="test">
                    <img src="static/images/test-img1.png" class="img-responsive slideanim" alt="">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="test">
                    <img src="static/images/test-img2.png" class="img-responsive slideanim" alt="">
                    <h4 class="text-center slideanim">Lorem Ipsum</h4>
                    <p class="t1 slideanim">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-4">
                <div class="test">
                    <img src="static/images/test-img3.png" class="img-responsive slideanim" alt="">
                    <h4 class="text-center slideanim">Lorem Ipsum</h4>
                    <p class="t1 slideanim">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                </div>
            </div>
...
<!-- js for gallery -->
<script src="static/js/darkbox.js"></script>
<!-- /js for gallery -->
<!-- js for back to top -->
